...
class InterviewSession:
    def __init__(self, session_id: str, resume_text: str, resume_url: str, skills: List[str],
                 jd_text: str = "", experience_info: Optional[Dict] = None):
        self.session_id = session_id
        self.resume_text = resume_text
        self.resume_url = resume_url
        self.skills = skills
        self.jd_text = jd_text
        self.experience_info = experience_info or {}
        ...
        # Each item: {question, difficulty, topic, time_limit}
...
class SessionManager:
    ...
    def create_session(self, resume_text: str, resume_url: str, skills: List[str],
                       jd_text: str = "", experience_info: Optional[Dict] = None) -> str:
        session_id = str(uuid.uuid4())
        self.sessions[session_id] = InterviewSession(
            session_id, resume_text, resume_url, skills, jd_text, experience_info
        )
        return session_id
